...
namespace Highrise.Studio.Generated
{
    internal static class LuaMenuItems
    {
        ...
        [MenuItem("Component/Lua/Tic Tac Toe Manager")]
        private static void AddComponent1() => AddScript("Assets/TicTacToe/TicTacToeManager.lua");
        [MenuItem("Component/Lua/Tic Tac Toe Tile Script")]
        private static void AddComponent2() => AddScript("Assets/TicTacToe/TicTacToeTileScript.lua");
        [MenuItem("Component/Lua/Highrise Camera Controller")]
        private static void AddComponent3() => AddScript("Packages/com.pz.studio/Assets/Game/Lua/HighriseCameraController.lua");
        [MenuItem("Component/Lua/RTS Camera")]
        private static void AddComponent4() => AddScript("Packages/com.pz.studio/Assets/Game/Lua/RTSCamera.lua");
